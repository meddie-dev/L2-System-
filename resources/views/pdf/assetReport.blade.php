<x-layout.pdfTemplate>
  ...
  <div class="container">
    <hr>
    <div style="margin-left: 15rem;"><h3>ASSET REPORT</h3></div>
     <!-- Vehicle Information -->
     <hr>
    <div class="section">
    ...
    <!-- Asset Information -->
    <hr>
    <h2 style="margin-bottom: 13px;">Asset Information</h2>
    <table class="table">
      <tr>
        <th>Key</th>
        <th>Information</th>
      ...
      <tr>
        <td>Year</td>
        <td>{{ $assetReport->year }}</td>
      </tr>
      <tr>
        <td>Annual Depreciation</td>
        <td>PHP {{ number_format($assetReport->annual_depreciation, 2) }}</td>
      </tr>
      <tr>
        <td>Maintenance Cost</td>
        <td>PHP {{ number_format($assetReport->maintenance_cost, 2) }}</td>
      </tr>
      <tr>
        <td>Recommendation</td>
        <td>{{ ucfirst($assetReport->recommendation) }}</td>
      </tr>
      <tr>
        <td>Created At</td>
        <td>{{ \Carbon\Carbon::parse($assetReport->created_at)->format('Y-m-d') }}</td>
      </tr>
    </table>
