        ...
        <div class="container tw-relative">
            <div class="row">
                <div class="col-lg-6 mx-auto">
                    ...
                    <p class="lead tw-mb-4">An unexpected error occurred. Please try again later or contact support if the issue persists.</p>
                    <a href="
                        @if (Auth::check())
            ...
            <div class="tw-absolute tw-bottom-[-13rem] tw-left-[-24rem] tw-opacity-30 | max-md:tw-bottom-[-7rem] max-md:tw-left-[-12rem] ">
                <img src="/img/logo_white.png" class="tw-w-[900px] tw-object-cover tw-h-[470px] tw-object-top tw-contrast-50 | max-md:tw-w-[500px] max-md:tw-h-[250px]">
            </div>
        </div>
    </div>
</x-layout.authTemplate>
