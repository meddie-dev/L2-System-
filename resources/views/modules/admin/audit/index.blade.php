          ...
          <tr class="hover:tw-bg-gray-100">
            <td class="tw-px-4 tw-py-2">
              <div class="tw-flex tw-justify-between">
                <a class="tw-text-blue-600 hover:tw-underline" href="{{ route('admin.audit.details', $reports->id) }}">
                  {{ $reports ? $reports->reportNumber : 'N/A' }}
                </a>
                <span class="tw-text-gray-500 tw-text-sm">
                  (Assigned and Reviewed By:
                  {{ $reports->reviewed_by !== null ? \App\Models\User::find($reports->reviewed_by)->firstName . ' ' . \App\Models\User::find($reports->reviewed_by)->lastName : 'N/A'}})
                </span>
              </div>
            </td>
