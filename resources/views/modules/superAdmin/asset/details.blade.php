<x-layout.portal.mainTemplate>
  <nav class="tw-flex | max-sm:tw-hidden" aria-label="Breadcrumb">
    <ol class="tw-inline-flex tw-items-center tw-space-x-1 | md:tw-space-x-2 rtl:tw-space-x-reverse max-sm:tw-text-sm">
      ...
      <x-partials.breadcrumb href="{{ route('superadmin.asset.index') }}" :active="false" :isLast="false">
        Asset Management
      </x-partials.breadcrumb>
    ...
    <div class="tw-flex tw-justify-start">
      <div class="tw-flex tw-items-center tw-justify-start tw-my-6">
        <a href="{{ route('superadmin.asset.index') }}" class="tw-flex tw-items-center tw-space-x-1 tw-text-sm tw-font-medium tw-text-gray-200  tw-bg-gray-600 tw-rounded-md tw-px-4 tw-py-2 hover:tw-border hover:tw-border-gray-600 hover:tw-bg-white  hover:tw-text-gray-600 | max-md:tw-p-3 ">
