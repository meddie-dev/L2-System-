      ...
      <table class="datatable tw-w-full tw-bg-white tw-rounded-md tw-shadow-md tw-my-4 | max-sm:tw-text-sm">
        ...
        <tbody id="reportRecords" class="tw-bg-white">
          ...
          <tr class="hover:tw-bg-gray-100">
            ...
            <td class="tw-px-4 tw-py-2"><a class="tw-text-blue-600 hover:tw-underline" href="{{ route('superadmin.fleet.driver.details', $driver->id) }}">{{ $driver->firstName }} {{ $driver->lastName }}</a></td>
            <td>{{ $driver->email}}</td>
