<x-layout.mainTemplate>
  <nav class="tw-flex tw-justify-between | max-md:tw-hidden" aria-label="Breadcrumb">
    ...
    <div class="tw-flex">
      <a href="{{ route('superadmin.fleet.vehicle.new') }}" class="tw-flex tw-items-center tw-space-x-1 tw-text-sm tw-font-medium tw-text-gray-200  tw-bg-gray-600 tw-rounded-md tw-px-4 tw-py-1 hover:tw-border hover:tw-border-gray-600 hover:tw-bg-white  hover:tw-text-gray-600 | max-md:tw-p-3 ">
      ...
      <table class="datatable tw-w-full tw-bg-white tw-rounded-md tw-shadow-md tw-my-4 | max-sm:tw-text-sm">
        ...
        <tbody id="reportRecords" class="tw-bg-white">
          ...
          <tr class="hover:tw-bg-gray-100">
            ...
            <td class="tw-px-4 tw-py-2"><a class="tw-text-blue-600 hover:tw-underline" href="{{ route('superadmin.fleet.edit', $vehicle->id) }}">{{ $vehicle->plateNumber }}</a></td>
