  ...
  <div class="card-body tw-px-4">
    ...
    <div class="tw-grid tw-grid-cols-3 tw-gap-4 tw-px-4 tw-text-sm tw-mb-4 | max-md:tw-text-xs max-md:tw-grid-cols-1 max-md:tw-gap-2">
      ...
      <div>
        ...
        <input type="text" id="departureDate" name="departureDate" class="tw-block tw-w-full tw-px-4 tw-py-2 tw-border tw-border-gray-300 tw-rounded-md tw-shadow-sm tw-opacity-50 tw-cursor-not-allowed | max-md:tw-text-xs" placeholder="ENTER ORDER NUMBER" value="{{ \Carbon\Carbon::parse($tripTicket->departureTime)->format('Y-m-d') }}" readonly>
      </div>
      <div>
        <label for="departureTime" class="tw-block tw-text-sm tw-font-medium tw-text-gray-500 | max-md:tw-text-xs">Departure Time:</label>
        <input type="text" id="departureTime" name="departureTime" class="tw-block tw-w-full tw-px-4 tw-py-2 tw-border tw-border-gray-300 tw-rounded-md tw-shadow-sm tw-opacity-50 tw-cursor-not-allowed | max-md:tw-text-xs" placeholder="ENTER ORDER NUMBER" value="{{ \Carbon\Carbon::parse($tripTicket->departureTime)->format('h:i A') }}" readonly>
      </div>

      <!-- Arrival -->
      <div>
        <label for="arrivalDate" class="tw-block tw-text-sm tw-font-medium tw-text-gray-500 | max-md:tw-text-xs">Arrival Date:</label>
        <input type="text" id="arrivalDate" name="arrivalDate" class="tw-block tw-w-full tw-px-4 tw-py-2 tw-border tw-border-gray-300 tw-rounded-md tw-shadow-sm tw-opacity-50 tw-cursor-not-allowed | max-md:tw-text-xs" placeholder="ENTER ORDER NUMBER" value="{{ \Carbon\Carbon::parse($tripTicket->arrivalTime)->format('Y-m-d') }}" readonly>
      </div>
      <div>
        <label for="arrivalTime" class="tw-block tw-text-sm tw-font-medium tw-text-gray-500 | max-md:tw-text-xs">Arrival Time:</label>
        <input type="text" id="arrivalTime" name="arrivalTime" class="tw-block tw-w-full tw-px-4 tw-py-2 tw-border tw-border-gray-300 tw-rounded-md tw-shadow-sm tw-opacity-50 tw-cursor-not-allowed | max-md:tw-text-xs" placeholder="ENTER ORDER NUMBER" value="{{ \Carbon\Carbon::parse($tripTicket->arrivalTime)->format('h:i A') }}" readonly>
      </div>
